...
function Hero() {
	...
	return (
		<section
			className={`${theme === "dark" ? "bg-gradient-to-br from-zinc-800 to-zinc-900 text-zinc-100 border-zinc-800" : "bg-zinc-100 text-zinc-700"} border rounded-4xl shadow-xl flex sm:flex-row items-center flex-col-reverse justify-between gap-5 sm:gap-15 py-10 px-5 sm:py-15 sm:px-10 md:px-20 max-w-[600px] md:max-w-[800px] mx-auto`}
		>
			<div className="flex flex-col self-center text-center sm:text-left sm:gap-1">
				...
				<Link to={"/contact"}>
					<button
						type="button"
						className="mt-2 bg-gradient-to-br from-blue-500 to-indigo-500 px-3 py-1 rounded-lg text-lg text-zinc-50 hover:from-blue-600 hover:to-indigo-600 hover:scale-105 cursor-pointer transition"
					>
						{content?.button}
					</button>
				</Link>
